...
mary_host = "localhost"
mary_port = "59125"
app_dir = "/home/ltrlservices/TTS/tts_streamlit/app"
...
# )
st.sidebar.markdown("""<h1 style='text-align: center; color:white; font-size:60px;margin-top:-50px; color:white;'><a style='text-align: center; color:white; font-size:60px;margin-top:-50px;text-decoration:none;' >සුබස</a></h1><h1 style='text-align: center; font-size:30px;margin-top:-30px;'></h1>""",unsafe_allow_html=True)
...
st.sidebar.markdown("""<h2 style='text-align: left;color:white; '>About</h2><p style='color: white;text-align: justify;'>In this project we focus on developing a human quality Text-to-Speech (TTS) systems for Sinhala. Human quality TTS, enables visually impaired community to use a computer and access digital text in their mother language. </p>""",unsafe_allow_html=True)
...
st.markdown("""<h1 style='text-align: center;font-size:60px;margin-top:-50px;'>Sinhala Text To Speech</h1><h1 style='text-align: center; font-size:30px;margin-top:-30px;'></h1>""",unsafe_allow_html=True)
html_temp = f"""
